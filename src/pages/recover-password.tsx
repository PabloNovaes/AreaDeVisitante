...
import { DefineNewPasswordForm } from "@/components/features/define-new-password-form"
import { containerVariants, fadeInVariants, itemVariants } from "@/moiton.config"
            ...
            return (
                <motion.div key="document-verification" className="grid gap-5" variants={containerVariants} initial="hidden" animate="show">
                    <div className="flex flex-col gap-5">
                        ...
                        />
                        <motion.h1 variants={itemVariants} initial='hidden' animate='show' exit='hidden' className="text-4xl font-bold tracking-tight">
                                                ...
                                                {visitorData.EMAIL_VISITA && (
                                                    <div className="flex items-center space-x-2">
                                                        ...
                                                        <Label className="text-[15px] leading-0" htmlFor="email">
                                                            <strong>Receber por email</strong> {visitorData.EMAIL_VISITA}
                                                        </Label>
                                                    </div>
                                                )}
                                                {visitorData.TELEFONE_VISITA && (
                                                    <div className="flex items-center space-x-2">
                                                        ...
                                                        <Label className="text-[15px] leading-0" htmlFor="telefone">
                                                            <strong>Receber por whatsapp</strong> {visitorData.TELEFONE_VISITA}
                                                        </Label>
                                                    </div>
                                                )}
                                            </RadioGroup>
